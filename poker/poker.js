...
$(function() {
  $(".deal").on("click", function(event) {
    ...
    var c1 = window.getDeck()[randomNumber()]
    var c2 = window.getDeck()[randomNumber()]
    var c3 = window.getDeck()[randomNumber()]
    var c4 = window.getDeck()[randomNumber()]
    var c5 = window.getDeck()[randomNumber()]
